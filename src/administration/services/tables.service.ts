...
export class TablesService implements DataService<Table> {
    private readonly URL_BASE: string = '/table'

    public async getRecord(key: string | number): Promise<Table> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<Table[]> {
        try {
    ...
    public async createRecord(data: Table | never[]): Promise<Table | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: Table | Record<string, any>): Promise<Table[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<Table[]> {
