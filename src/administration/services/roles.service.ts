...
export class RoleService implements DataService<Role> {
    private readonly URL_BASE: string = '/role'

    public async getRecord(key: string | number): Promise<Role> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<Role[]> {
        try {
    ...
    public async createRecord(data: Role | never[]): Promise<Role | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: Role | Record<string, any>): Promise<Role[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<Role[]> {
