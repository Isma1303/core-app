...
export class ActionsService implements DataService<Action> {
    private readonly URL_BASE: string = '/action'

    public async getRecord(key: string | number): Promise<Action> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<Action[]> {
        try {
    ...
    public async createRecord(data: Action | never[]): Promise<Action | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: Action | Record<string, any>): Promise<Action[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<Action[]> {
