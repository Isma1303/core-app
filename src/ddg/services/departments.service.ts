...
export class DepartmentsService implements DataService<IDepartments> {
    private readonly URL_BASE: string = '/ddg/departments'

    public async getRecord(key: string | number): Promise<IDepartments> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<IDepartments[]> {
        try {
    ...
    public async createRecord(data: IDepartments | never[]): Promise<IDepartments | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: IDepartments | Record<string, any>): Promise<IDepartments[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<IDepartments[]> {
