...
import { IUserCard } from '../interfaces/user_cards.interface'

export class UserCardsService implements DataService<IUserCard> {
    private readonly URL_BASE: string = '/ddg/user-cards'

    public async getRecord(key: string | number): Promise<IUserCard> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<IUserCard[]> {
        try {
    ...
    public async createRecord(data: IUserCard | never[]): Promise<IUserCard | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: IUserCard | Record<string, any>): Promise<IUserCard[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<IUserCard[]> {
