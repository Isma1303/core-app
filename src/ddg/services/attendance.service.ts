...
export class AttendanceService implements DataService<IAttendance> {
    private readonly URL_BASE: string = '/ddg/attendance'

    public async getRecord(key: string | number): Promise<IAttendance> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<IAttendance[]> {
        try {
    ...
    public async createRecord(data: IAttendance | never[]): Promise<IAttendance | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: IAttendance | Record<string, any>): Promise<IAttendance[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<IAttendance[]> {
