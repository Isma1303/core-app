...
import { IDepartmentMember } from '../interfaces/department_members.interface'

export class DepartmentMembersService implements DataService<IDepartmentMember> {
    private readonly URL_BASE: string = '/ddg/department-members'

    public async getRecord(key: string | number): Promise<IDepartmentMember> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<IDepartmentMember[]> {
        try {
    ...
    public async createRecord(data: IDepartmentMember | never[]): Promise<IDepartmentMember | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: IDepartmentMember | Record<string, any>): Promise<IDepartmentMember[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<IDepartmentMember[]> {
