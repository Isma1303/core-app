...
import { IUserDepartment } from '../interfaces/user_departments.interface'

export class UserDepartmentsService implements DataService<IUserDepartment> {
    private readonly URL_BASE: string = '/ddg/user-departments'

    public async getRecord(key: string | number): Promise<IUserDepartment> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<IUserDepartment[]> {
        try {
    ...
    public async createRecord(data: IUserDepartment | never[]): Promise<IUserDepartment | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: IUserDepartment | Record<string, any>): Promise<IUserDepartment[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<IUserDepartment[]> {
