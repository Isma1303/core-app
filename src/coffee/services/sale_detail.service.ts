...
import { ISaleDetail } from '../interfaces/sale_detail.interface'

export class SaleDetailService implements DataService<ISaleDetail> {
    private readonly URL_BASE: string = '/coffe/sale_detail'

    public async getRecord(key: string | number): Promise<ISaleDetail> {
        try {
    ...
    public async getRecords(offset: number, limit: number, orden?: string): Promise<ISaleDetail[]> {
        try {
    ...
    public async createRecord(data: ISaleDetail | never[]): Promise<ISaleDetail | never[]> {
        try {
    ...
    public async updateRecord(key: string | number, data: ISaleDetail | Record<string, any>): Promise<ISaleDetail[]> {
        try {
    ...
    public async search(conditions: Condition[], offset: number, limit: number, orden?: string): Promise<ISaleDetail[]> {
